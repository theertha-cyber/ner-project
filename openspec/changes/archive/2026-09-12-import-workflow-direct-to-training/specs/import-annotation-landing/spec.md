...
Removed. This surface no longer exists as a distinct, eligibility-gated banner — "Train model"
is now step 2 of the "Workflow Steps" requirement below, always shown, with no eligibility gate.
