...
Defines the set of foundational UI components available to all portal pages — status badges, stat cards, slide-over panels, progress bars, segment controls, spinners, placeholder screens, and the auth fetch stub — along with barrel exports and unit test coverage requirements.
