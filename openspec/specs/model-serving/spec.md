...
Internal inference layer that loads ONNX models into an in-memory LRU cache and exposes a per-tenant inference endpoint consumed by the extraction service.
