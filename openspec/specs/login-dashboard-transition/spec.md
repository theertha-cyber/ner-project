# Spec: Login-to-Dashboard Transition

## Purpose

Defines the animated transition that plays between a successful login and the rendering of the dashboard: a full-screen orb-burst overlay on the login page followed by a fade-in of the dashboard layout.
