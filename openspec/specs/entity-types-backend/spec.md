# Spec: Entity Types Backend

## Purpose

Defines the backend API contract for managing entity type definitions within a tenant. Covers routing, identifier conventions, response shape, JSON column deserialization, and partial-update (PATCH) behaviour for the entity types resource.
