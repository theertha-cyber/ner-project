...
Defines the foundational workspace structure for the portal — Next.js 14 App Router, TypeScript configuration, tooling, environment variable interface, root layout, and test infrastructure — establishing the baseline from which all other portal capabilities are built.
