# external-postgresql-chat Specification

## Purpose
TBD - created by archiving change cap-4-contract-governed-external-postgresql-query-path. Update Purpose after archive.
## Requirements
