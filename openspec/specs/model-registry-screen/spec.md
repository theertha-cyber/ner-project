...
TBD — frontend specification for the Model Registry screen (`/models`), covering the model versions list, detail panel, and role-gated promote/demote/warmup actions. See `openspec/specs/model-registry/spec.md` for the backend API spec.
