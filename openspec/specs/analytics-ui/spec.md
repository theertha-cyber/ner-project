...
Provides the portal-side analytics page with pre-built dashboard widgets, ad-hoc query controls, export buttons, and appropriate loading, empty, and error states.
