...
Defines how the `TenantContextMiddleware` in backend services handles HTTP OPTIONS requests, ensuring browser CORS preflight requests are not blocked by authentication checks.
