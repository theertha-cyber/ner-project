...
<!-- TBD: This spec covers the documented procedure for rebuilding the local development database and Docker images from a clean state, and the post-rebuild schema verification that guards against drift. -->
