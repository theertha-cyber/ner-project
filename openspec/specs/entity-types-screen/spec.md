...
This capability covers the Entity Types management screen available to Tenant Admins. It includes the list page, entity type cards, the define/edit slide-over, activate/deactivate toggling, and the underlying TanStack Query API hooks.
