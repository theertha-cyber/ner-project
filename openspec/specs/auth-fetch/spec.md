...
Authenticated HTTP fetch wrapper for all portal API calls. Handles service URL routing, Bearer token injection, and transparent 401 silent-refresh with deduplication.
