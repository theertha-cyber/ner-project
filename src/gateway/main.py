...
from src.gateway.api.v1 import admin, auth, entity_types, users, extraction_proxy, dashboard, chat_proxy, analytics_proxy, data_sources, external_pg_contracts, training_readiness, notifications
...
# body quoting it.
init_observability("gateway", app)
