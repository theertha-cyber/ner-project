...
export default function JobsPage() {
  ...
  useEffect(() => {
    apiFetch<{ jobs: TrainingJob[] }>("/api/v1/admin/jobs")
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">F1 Score</th>
              </tr>
            </thead>
              ...
              {jobs.length === 0 ? (
                ...
                jobs.map((job, i) => (
                  <tr key={i} className="hover:bg-gray-50">
                    <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-900">{job.tenant_name}</td>
                    ...
                    <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-500">{job.model_version || "-"}</td>
                    <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-500">{job.duration || "-"}</td>
