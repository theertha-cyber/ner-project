# Graph Report - ner-project  (2026-09-13)

## Corpus Check
- 1866 files · ~1,876,435 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21910 nodes · 34105 edges · 1367 communities (1234 shown, 41 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 1133 edges (avg confidence: 0.91)
...
- test_chat_api_conversations.py
...
- TestSubjectColumnTypeConvergence
...
## Communities (1367 total, 41 thin omitted)

### Community 0 - "FakeSession"
Cohesion: 0.03
Nodes (82): FakeLLM, FakeSession, _answer_from(), _AnswerLLM, _orchestrator(), Bounded SQL recovery through the retrieval and answer-generation stages —…, Row 24 — an honest refusal, not a confident empty answer., Row 28 — rejected before execution, retried within budget, reported. (+74 more)

### Community 1 - "test_tenant_credential_hygiene.py"
Cohesion: 0.05
Nodes (67): The three declared retention modes. Its own module, with no imports, because…, The declared set of adapter selections, and which of them are executable. A…, Names of the slots whose recorded selection is not executable in this change., unsupported_selections(), declared_secret_fields(), InvalidSecretReference, ProfileValidationError, Exception (+59 more)

### Community 2 - "authFetch"
Cohesion: 0.03
Nodes (108): JobsPage(), TrainingJob, ROLES, TenantDetail, TenantDetailPage(), TenantUser, mockAuthFetch, TENANT (+100 more)

### Community 3 - "AnnotationPage.tsx"
Cohesion: 0.03
Nodes (75): AnnotationActionBar(), AnnotationActionBarProps, SAVE_LABELS, SaveState, task, AnnotationPage(), mockAuthFetch, MY_TASK (+67 more)
...
Cohesion: 0.06
Nodes (65): classify_processing_error(), ContentUnresolvable, _embed_chunks(), extract_text_doc(), extract_text_pdf(), get_extension(), _load_document(), _media_type_from_content() (+57 more)

### Community 8 - "DocumentIngestionService"
Cohesion: 0.09
Nodes (65): AST, requires_real_stores, Where this document came from, in the source's own terms. Timestamps are never…, SourceReference, Records dispatches without executing them. For tests and for verification row…, RecordingDispatcher, DocumentIngestionService, test_failed_processing_stores_class_without_traceback() (+57 more)

### Community 9 - "_context"
Cohesion: 0.06
Nodes (25): _context(), _make_results(), RaisingRetriever, Covers verification.md row 30., Covers verification.md row 26., Covers verification.md row 27., Covers verification.md row 28 (non-integration slice)., Covers verification.md row 29. (+17 more)

### Community 10 - "SQLGenerator"
Cohesion: 0.06
Nodes (37): _metrics(), AsyncSession, Executes an already-validated statement and returns its rows. When…, The total the statement would have matched without its row limit, or None if…, Bounded, representative values per stored `entity_type`, still read from the…, Why the relational surface cannot answer at all, or None when it can. The…, The querying tenant's relational surface, from the shared resolver. Resolved…, The tenant's relations and columns, their semantics, and their real values.… (+29 more)

### Community 11 - "_spec"
Cohesion: 0.06
Nodes (37): build_relational_delete_statements(), `sql_identifier -> entities routed to it`, skipping every unroutable entity. An…, The one value a `single` definition contributes to the document's `subject`…, The value a `subject` column receives, decided by the definition's…, Clear this document from every **existing** generated table, plus its `subject`…, route_entities(), select_single_value(), value_for_column() (+29 more)

### Community 12 - "relational_projection.py"
Cohesion: 0.09
Nodes (28): build_projection_statements(), _checked_table(), _child_insert(), _child_params(), Projects a document's final entity list into the tenant's generated relational…, `confidence` and `page_number` are projected; provenance is not.…, Every statement that writes this document's relational rows. Executes nothing.…, Re-validate a catalog identifier before it reaches an identifier position.… (+20 more)

### Community 13 - "RetrievalResult"
Cohesion: 0.03
Nodes (72): _store_chunks(), chunk_text(), Any, resolve_rerank_candidate_count(), resolve_reranker_enabled(), resolve_top_k(), Chunk, BaseModel (+64 more)

### Community 14 - "FakeSession"
Cohesion: 0.04
Nodes (41): FakeLLM, _FakeResult, FakeSession, _generator(), A rejected statement has to be visible even when INFO is turned off., End to end through the real handler, since that is what `docker logs` sees., Answers the profile queries from canned tables and every data query with one…, _sql_attempt_records() (+33 more)

### Community 15 - "chat_api/api/v1/schemas.py"
Cohesion: 0.09
Nodes (29): get_session(), AsyncSession, get, options, post, Request, serve_widget_js(), widget_chat() (+21 more)
...
Cohesion: 0.05
Nodes (72): JSONResponse, Response, app_error_handler(), exception_handler, Request, BaseHTTPMiddleware, Request, TenantContextMiddleware (+64 more)

### Community 18 - "data-sources.ts"
Cohesion: 0.03
Nodes (98): react-dom, DetailContent(), UPDATABLE, ContractsContent(), handlePublish(), handleUpload(), DataSourcesContent(), isOrder() (+90 more)

### Community 19 - "domain_metrics.py"
Cohesion: 0.04
Nodes (73): main(), Regenerate `docs/observability/metric-contract.md` from the live declarations.…, render_family(), _defect_class(), The defect's category, without its payload. `SQLAttempt.defect` carries the…, _record_metric(), allowlist_violations(), _ambient_tenant() (+65 more)
...
### Community 22 - "vitest"
Cohesion: 0.03
Nodes (84): @tanstack/react-query, @testing-library/react, vitest, SettingsPage(), mockFetch, mockReplace, TrainingJobsPage(), ViewMode (+76 more)

### Community 23 - "entity_views.py"
Cohesion: 0.05
Nodes (59): _async_dsn(), main(), Provision the least-privilege role that generated chat SQL executes under, then…, build_role_statements(), _checked_identifier(), InvalidIdentifierError, list_tenant_schemas(), provision_role() (+51 more)

### Community 24 - "DenseRetriever"
Cohesion: 0.03
Nodes (83): _fake_vector(), FakeEmbeddingService, main(), Manual playground for HybridRetriever/SparseRetriever/DenseRetriever — no…, Returns a fixed query vector — swap for the real EmbeddingService if you have…, run_query(), setup(), EmbeddingService (+75 more)

### Community 25 - "NotFoundError"
Cohesion: 0.04
Nodes (48): create_tenant(), create_tenant_user(), CreateTenantRequest, deactivate_tenant(), get_tenant(), list_audit_log(), list_tenant_users(), list_tenants() (+40 more)

### Community 26 - "@testing-library/user-event"
Cohesion: 0.04
Nodes (31): @testing-library/user-event, AuditEventRow(), AuditPage(), formatTimestamp(), KIND_COLORS, mockEvents, mockRefetch, mockTenants (+23 more)

### Community 27 - "RetrievalConfig"
Cohesion: 0.05
Nodes (74): ContextFactory, KeyError, _create_schema(), main(), CLI entry point for the retrieval eval harness. Seeds the committed synthetic…, Per-instance/per-call override for retrieval behaviour settings. Any field left…, RetrievalConfig, EmbeddingModelMismatchError (+66 more)
...
Cohesion: 0.05
Nodes (45): accepted_columns(), accepted_relations(), _error_class(), _fix_document_name_reference(), _force_nulls_last_on_desc(), _is_identifier_token(), iter_table_references(), _parse_table_list() (+37 more)

### Community 32 - "ui/index.ts"
Cohesion: 0.05
Nodes (39): ModelActionsProps, completedModel, mockFetch, mockUser, CORE_METRIC_KEYS, ModelDetailPanel(), ModelDetailPanelProps, truncateUrl() (+31 more)

### Community 33 - "test_chat_api_sql_retry.py"
Cohesion: 0.06
Nodes (35): Raised when every attempt failed. Deliberately an exception rather than a…, Closed set of per-attempt outcomes. `EMPTY_WITH_DEFECT` is the *only* way a…, Renders prior attempts into the corrective block appended to a retry prompt. At…, One pass of generate -> validate -> execute -> classify., _render_attempt_feedback(), SQLAttempt, SQLAttemptOutcome, SQLGenerationFailed (+27 more)

### Community 34 - "Source"
Cohesion: 0.06
Nodes (19): Queue, skip, Source, AsyncSession, Citation, The turn's retrieval outcome as a plain dict for the HTTP layer. `None` on a…, Per design.md Decision 6: reuses the `model_version` identifier already…, `schema` comes from the caller's authenticated request context and is passed… (+11 more)

### Community 35 - "_spec"
Cohesion: 0.05
Nodes (38): _active(), build_child_table_statements(), build_entity_table_statements(), build_subject_table_statements(), catalogued_table_names(), child_index_name(), entity_type_literals(), expected_table_names() (+30 more)

### Community 36 - "logging_config.py"
Cohesion: 0.02
Nodes (114): Formatter, Handler, LogRecord, current_context(), get_tenant_id(), get_trace_id(), get_user_hash(), Ambient request context for telemetry. Threading… (+106 more)

### Community 37 - "eval/metrics.py"
Cohesion: 0.20
Nodes (21): Judgment, compute_query_metrics(), _grade_map(), Judgment, mrr_at_k(), ndcg_at_k(), precision_at_k(), RankedItem (+13 more)

### Community 38 - "blob_sync/__init__.py"
Cohesion: 0.08
Nodes (29): AzureBlobLiveProvider, SDK-backed Azure Blob provider (CAP-3, ADR-012). Replaces…, One tenant connection's live Azure Blob container, via the SDK., Durable Azure Blob synchronization runtime (CAP-3, ADR-012). One tenant-bound…, BlobListingFailed, BlobObject, BlobObjectMissing, BlobProvider (+21 more)
...
### Community 40 - "shared/config.py"
Cohesion: 0.03
Nodes (113): AsyncEngine, Sync tenant_{id} schemas with tenant_template. Clones missing tables and adds…, get_db(), AsyncSession, Request, add_bearer_security(), health(), lifespan() (+105 more)

### Community 42 - "chat_proxy.py"
Cohesion: 0.13
Nodes (28): _proxy(), proxy_chat(), proxy_chat_stream(), proxy_create_conversation(), proxy_create_widget_key(), proxy_delete_conversation(), proxy_get_conversation(), proxy_list_conversations() (+20 more)
...
Cohesion: 0.11
Nodes (33): create_extraction_run(), find_existing_run(), get_already_extracted(), get_extraction_run(), _get_sync_engine(), insert_entity(), list_extraction_runs(), list_processed_document_ids() (+25 more)

### Community 45 - "external_postgres/__init__.py"
Cohesion: 0.06
Nodes (43): external_chat_answer(), ExternalNotExecutable, Exception, External PostgreSQL chat capability (CAP-4, ADR-013). A separate selection from…, Answer one external chat turn: resolve, then drift-gated execution. Returns…, No executable external capability for this tenant; finite reason only., _build_system_prompt(), Contract-grounded external SQL generation (ADR-016). Turns a natural-language… (+35 more)

### Community 46 - "sync.py"
Cohesion: 0.04
Nodes (70): delete_document(), get_document(), get_document_text(), get_session(), get_tenant_id(), list_documents(), AsyncSession, delete (+62 more)
...
Cohesion: 0.07
Nodes (23): GuardrailService, _metrics(), One classifier call. Returns True (in-domain) on any error, so a provider…, Returns True if the query is in-domain. Fails open (treats the query as in-…, Only `generation_node` calls this. An entity-resolution clarification reply…, The domain-metric recorders, resolved on first use. `domain_metrics` imports…, Deterministic short-circuits that decline without an LLM call: a reference to…, _Classifier (+15 more)
...
Cohesion: 0.09
Nodes (69): acquire_lease(), confirm_missing(), ensure_sync_tables(), get_source(), hidden_document_ids(), hide_document(), last_successful_run_at(), ledger_identities() (+61 more)

### Community 55 - "build_default_registry"
Cohesion: 0.06
Nodes (61): RuntimeError, orchestrate_retrieval(), Top-level entry point: plans, executes, and degrades to a fallback plan (both…, build_default_registry(), _budget(), _context_factory(), _make_chunk(), Exception (+53 more)

### Community 56 - "session_factory"
Cohesion: 0.14
Nodes (44): activate_profile(), Move a profile to `validated` once its selections and references check out.…, Activate a validated profile, unless it selects something not yet executable., Any other permitted move, including `→ retired` and pause/resume., Record a profile. Validation is by declared schema, never by value inspection.…, _set_status(), transition_profile(), validate_profile() (+36 more)

### Community 57 - "DocumentUpload.test.tsx"
Cohesion: 0.12
Nodes (10): ACCEPTED_TYPES, BatchItem, DocumentUpload(), DocumentUploadProps, FileStatus, Deferred, deferreds, uploadCalls (+2 more)
...
### Community 59 - "Base"
Cohesion: 0.06
Nodes (33): DeclarativeBase, AuditEvent, Base, EntityDefinition, str, slugify(), Tenant, TenantStatus (+25 more)

### Community 60 - "react"
Cohesion: 0.03
Nodes (66): lucide-react, react, react-markdown, remark-gfm, ChatPage(), Conversation, Message, Source (+58 more)

### Community 61 - "app"
Cohesion: 0.05
Nodes (35): ProcessingMode, Enum, str, The processing mode a batch extraction run executes under. The mode is chosen…, app(), fixture, auth_header(), asyncio (+27 more)
...
Cohesion: 0.09
Nodes (16): Renders the turn's retrieval outcome for the answer model, or None when every…, render_retrieval_status(), CapabilityStatus, What one plan entry actually did. `error` holds the specific failure text,…, The turn's retrieval outcome, as one value with named consumers. Replaces…, The strongest signal any invocation of this capability produced, ordered failed…, RetrievalStatus, A turn that never reached retrieval passes no status; behaviour is unchanged. (+8 more)

### Community 66 - "observability/spans.py"
Cohesion: 0.18
Nodes (6): BaseException, Span helpers for the workload instrumentation. Auto-instrumentation gives one…, Attribute setter that is a no-op when there is no live span., The exception's *class*, not its message. A driver message quotes the offending…, _Setter, _tracer()

### Community 67 - "tracked_tenants"
Cohesion: 0.10
Nodes (35): active_connection(), parametrize, Verification for the manual Azure Blob sync trigger. Maps to…, test_broker_unavailable_returns_safe_code(), test_connection_reports_latest_completed_sync_run(), test_cross_tenant_manual_sync_is_not_found(), test_inactive_connection_enqueues_nothing(), test_manual_sync_enqueues_manual_trigger() (+27 more)
...
Cohesion: 0.05
Nodes (42): Favicon — dark theme SVG, Logo — dark theme SVG, Hardcoded-color-to-CSS-variable mapping (text-gray-900 -> var(--ink), bg-white -> var(--surface-2), etc.), Design: Fix Dark Theme Issues Across Portal Pages, Proposal: Fix Dark Theme Issues Across Portal Pages, Fix Dark Theme Issues - Tasks, In-app Logo SVG, Logo (Dark Theme) SVG (+34 more)

### Community 72 - "test_config_secret_hygiene.py"
Cohesion: 0.12
Nodes (9): Opaque user identity for telemetry. Support needs to follow one person's…, Secret-class settings must have no default, including the new telemetry pepper.…, parametrize, The telemetry user hash correlates without identifying. Verification row 16.…, Row 16 — two requests from one user produce equal hashes., Correlation across a rotation breaks by design — the design records this as a…, An unauthenticated request and a widget-key session have no user. Hashing the…, TestAbsentUser (+1 more)
...
Cohesion: 0.12
Nodes (36): is_external_request_executable(), Resolve the tenant's executable external-query capability. Returns…, Whether one named connection may serve this tenant's external request., resolve_external_capability(), clamp_limit(), execute_external_query(), Enforce the server row cap: keep a smaller LIMIT, else append one., Run one drift-gated, validated, parameterized external SELECT. Returns… (+28 more)
...
### Community 77 - "propagation.py"
Cohesion: 0.05
Nodes (40): Clear all four. Used by the Celery task-postrun hook, where the worker process…, reset_context(), set_trace_id(), record_celery_duration(), record_celery_retry(), record_celery_worker_up(), _configured_queue(), instrument_celery() (+32 more)
...
### Community 82 - "test_langsmith_correlation.py"
Cohesion: 0.12
Nodes (15): _langsmith_extra(), `langsmith_extra` for the wrapped client, resolved on use and never raising., langsmith_extra(), One hop between a LangSmith run and the OTel trace it happened inside. They are…, `langsmith_extra=` for one wrapped provider call, or `{}` when unavailable.…, _run_id_setter(), current_trace_id(), The ambient trace id as a 32-character hex string, or None outside a trace. (+7 more)

### Community 83 - "ContextAssembler"
Cohesion: 0.04
Nodes (62): AdmittedEvidence, _bounded(), build_system_prompt(), collapse_duplicate_rows(), ContextAssembler, _count_tokens(), _dedupe_chunks(), _fit_external_rows() (+54 more)
...
Cohesion: 0.08
Nodes (15): HistorySensitiveClassifierClient, Exception, parametrize, Covers verification.md row 44., Covers verification.md rows 41-43, 45-46, 55., A question the classifier calls in-domain on its own must not be declined just…, The mirror case: an anaphoric follow-up ("and him?") reads as out-of-domain…, Genuine out-of-domain requests read the same way with and without history, so… (+7 more)
...
Cohesion: 0.12
Nodes (40): _get_tenant_id(), _get_user_id(), list_entities(), patch_entity(), AsyncSession, get, Request, extract_entities() (+32 more)
...
### Community 98 - "RAGOrchestrator"
Cohesion: 0.03
Nodes (96): _DummyOrchestrator, main(), Generates a Mermaid diagram for the chat graph's single, fixed topology using…, build_nodes() only closes over this; node bodies never run here., setter, PendingClarification, build_chat_graph(), Compiles the chat graph topology. With `entity_resolution_enabled` off (the… (+88 more)

### Community 99 - "test_telemetry_failure_isolation.py"
Cohesion: 0.09
Nodes (18): build_tracer_provider(), init_tracing(), Register the auto-instrumentors, each independently. One instrumentor failing —…, Construct this process's provider, with an exporter only if one is configured.…, Install the tracer provider and register auto-instrumentation. Idempotent: a…, _register_instrumentors(), app_with_unreachable_collector(), _get() (+10 more)
...
Cohesion: 0.10
Nodes (36): _compute_bio_tags(), create_span(), delete_span(), generate_uuid(), get_session(), get_tenant_id(), list_spans(), prelabel_document() (+28 more)

### Community 111 - "test_entity_resolver_mentions.py"
Cohesion: 0.08
Nodes (20): _depossessive(), _extract_mentions(), _mention_matches(), Whether a mention identifies the person whose stored name is…, Returns (raw_ngram, canonical_ngram, word_count) for every contiguous 1-3 word…, Strips a trailing possessive from a canonical mention, or None if there is…, _coro(), _FakeSession (+12 more)

### Community 112 - "inference_service.py"
Cohesion: 0.13
Nodes (27): WarmupRequest, post, Request, warmup_endpoint(), _get_base_pipeline(), _get_tokenizer(), infer(), _infer_window() (+19 more)

### Community 113 - "gateway/dependencies.py"
Cohesion: 0.08
Nodes (41): create_entity_type(), delete_entity_type(), EntityTypeCreate, EntityTypeToggle, EntityTypeUpdate, get_entity_type(), list_entity_types(), AsyncSession (+33 more)
...
### Community 115 - "chat.py"
Cohesion: 0.15
Nodes (27): chat(), chat_stream(), _check_tenant_and_rate_limit(), create_conversation(), delete_conversation(), get_conversation(), get_session(), list_conversations() (+19 more)
...
Cohesion: 0.13
Nodes (11): A statement that outruns the 10s bound is cancelled, the transaction is rolled…, verification.md row 1 and Risk 7 — the prompt teaches the relational surface,…, Row 1 — no instruction to select from `document_entities`, and no `entity_type`…, Row 5.5 — the graph's scope filter and citation assembly both need it., Task 5.3 — the guidance that was never EAV-specific stays., Task 5.4 — document metadata questions still work; the EAV store is not offered., verification.md rows 6, 7, 13 — the execution path either runs a validated…, definition_row() (+3 more)
...
Cohesion: 0.03
Nodes (69): _candidates_from_json(), _candidates_to_json(), clear_binding(), clear_pending(), ConversationState, decode_document_ids(), encode_document_ids(), increment_reask() (+61 more)
...
Cohesion: 0.06
Nodes (38): OrchestrationBudget, _create_chunks_table(), _fake_vector(), FakeEmbeddingService, _insert_chunk(), _insert_document(), fixture, Covers verification.md row 18. (+30 more)
...
### Community 144 - "_SurfaceSession"
Cohesion: 0.11
Nodes (15): Answers `_QUERY_SURFACE_QUERY` from canned `public.entity_definitions` rows.…, verification.md rows 66-71 — the one authoritative description of the readable…, Rows 66, 68 — identifiers alone are not enough; a consumer needs the types., Row 68 — without `value_kind` on the row every column resolves TEXT, and a…, Row 67 — the tenant-authored semantics travel with the relation., `examples` reads back as text on a TEXT column and as a list on JSONB., Row 69 — inactive, identifier-less, and `single`-retained tables stay off., Row 70 — one tenant's `e_skill` says nothing about another's surface. (+7 more)
...
Cohesion: 0.28
Nodes (23): create_access_token(), fixture, system_admin_header(), tenant_admin_header(), auth_header(), AsyncClient, asyncio, fixture (+15 more)
...
Cohesion: 0.36
Nodes (10): create_task(), generate_uuid(), get_session(), get_tenant_id(), list_tasks(), AsyncSession, get, post (+2 more)
...
### Community 159 - "AnnotationImportPreview.tsx"
Cohesion: 0.19
Nodes (15): AnnotationImportPreviewProps, PreviewState, makeQC(), mockAuthFetch, mockUseEntityTypes, renderPreview(), computeEntityTypeCounts(), detectFormat() (+7 more)
...
Cohesion: 0.16
Nodes (26): canonical_fingerprint(), CanonicalContract, ContractValidation, _is_safe_name(), _normalize_relations(), Canonical schema-contract lifecycle (CAP-4, ADR-013). A contract declares…, Keeps only the canonical relation keys before persistence, so an unknown key…, Deterministic fingerprint over sorted relations/columns/normalized joins. (+18 more)
...
### Community 190 - "test_chat_api_conversations.py"
Cohesion: 0.17
Nodes (6): field_validator, ConversationRenameRequest, ConversationRenameResponse, derive_conversation_title(), TestConversationRenameRequest, TestConversationTitleGeneration

### Community 191 - "test_document_ocr_image.py"
Cohesion: 0.18
...
Cohesion: 0.11
Nodes (17): eslint, eslint-config-next, eslint-config-prettier, jsdom, postcss, @testing-library/jest-dom, @types/node, @types/react (+9 more)
...
### Community 236 - "TestSubjectColumnTypeConvergence"
Cohesion: 0.11
Nodes (10): `ADD COLUMN IF NOT EXISTS` does nothing to a column that already exists, so a…, Row 1 — the `PHONE_NUMBER` shape: catalog says number, disk says text., Rows 1-3 — including the pair PostgreSQL provides no cast between., Row 6 — `ADD COLUMN` in the same statement list creates it at the declared type., Row 11 — a deactivated or `multi`-flipped definition's column is retained…, A cast that succeeds is still wrong: the column holds a projection computed…, Row 9 — asserted over the whole script, as the rest of this module's DDL is., Risk 1 — every type `subject_column_type` can return needs a spelling, or that… (+2 more)
...
Cohesion: 0.15
Nodes (34): enqueue_sync(), activate_data_source(), _body_digest(), create_data_source(), _created(), _enqueue_blob_sync(), _error(), _idempotency_key() (+26 more)
...
Cohesion: 0.13
Nodes (7): _count_rejection(), Count one rejection, splitting the bucket key into its scope and tenant. Keys…, SlidingWindowRateLimiter, record_rate_limit_rejection(), The tenant label here is deliberate: a rejected request produces the least…, TestRateLimitRejectionsAreCounted, TestRateLimiter
...
Cohesion: 0.13
Nodes (14): ChatResponse, Per-capability retrieval outcome for the turn. Additive: a client that ignores…, RetrievalStatusOut, Covers verification.md row 6: status/empty-sources contract for a clarification…, TestClarificationResponseShape, _app(), auth_header(), CannedOrchestrator (+6 more)

### Community 527 - "lifecycle.py"
Cohesion: 0.17
Nodes (13): Finite lifecycle, test, and activation evidence classes (CAP-2). Every value…, active_connection(), executable_providers(), is_selection_executable(), Server-side tenant capability resolution for approved Azure connections…, The tenant's active connection of one approved provider, or None. Unknown…, Approved providers the tenant may execute right now, sorted., Whether one recorded profile selection may serve a request. Platform defaults… (+5 more)
...
### Community 902 - "Citation"
Cohesion: 0.13
Nodes (8): Citation, ConversationCreateResponse, ConversationSummary, MessageResponse, asyncio, verification.md rows 16, 17, 20, 21 — the RAG chat endpoint's existing…, TestChatEndpointTurnShape, TestConversationSchemas
...
### Community 1170 - "TestSmokeCheckCoversGeneratedRelations"
Cohesion: 0.32
Nodes (5): verification.md rows 72, 73 — provisioning is where a missing grant has to…, Row 73 — the operator has to know which grant to fix., The static path is unchanged: omitting the surface checks the whitelist alone., A catalogued relation with no table is not a provisioning failure. The tenant's…, TestSmokeCheckCoversGeneratedRelations
...
Cohesion: 0.03
Nodes (97): ExternalAnswer, The generator's outcome for one question. `reason` is `None` on success; every…, Single definition of how much prior conversation each LLM call sees, and how it…, The trailing window of history, oldest first. Empty list when there is none., The same window rendered as `role: content` lines, for the prompts that…, recent_messages(), render_history(), A span for one stage, yielding a setter for attributes decided inside the… (+89 more)
...
Cohesion: 0.33
Nodes (7): export_annotations(), get_session(), get_tenant_id(), AsyncSession, get, Request, _tokenize()

### Community 1330 - "TestPendingClarificationSerialization"
Cohesion: 0.33
Nodes (5): CandidateEntity, _candidates_to_schema(), Candidate, Covers verification.md rows 6, 7: `pending_clarification` is present with…, TestPendingClarificationSerialization
...
### Community 1356 - "_filename_filter_literals"
Cohesion: 0.43
...
### Community 1357 - "AnnotationImportFlow.test.tsx"
Cohesion: 0.29
Nodes (5): mockAuthFetch, mockUseAnnotationImport, mockUseAuth, mockUseEntityTypes, ImportedDocumentsPage()
...
### Community 1363 - "axe-scan.mjs"
Cohesion: 0.50
Nodes (3): results, @axe-core/playwright, @playwright/test

### Community 1365 - "app_error_handler"
Cohesion: 0.67
Nodes (3): app_error_handler(), exception_handler, Request

### Community 1366 - "enqueued"
Cohesion: 0.67
...
## Knowledge Gaps
- **9216 isolated node(s):** `$schema`, `plugin`, `vendorRoot`, `SessionMessage`, `SessionMessageInfo` (+9211 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 12313 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
