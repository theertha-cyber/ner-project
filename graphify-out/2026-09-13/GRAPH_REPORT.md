...
## Corpus Check
- 1842 files · ~1,848,471 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 21577 nodes · 33504 edges · 1353 communities (1216 shown, 45 thin omitted)
...
- ADDED Requirements
- test_no_pii_in_chat_telemetry.py
- Requirements
- _post_feedback
- test_document_provenance_migration.py
- _compute_bio_tags
- TestValueKindChangeConvergesTheColumn
...
- _FakeSession
- TestTheDefectPayloadNeverBecomesALabel
...
- Verification Plan
- TestOneChatRequestLeaksNothing
- ADDED Requirements
...
- TestExecutionIsMeasured
- RuntimeError
- Deployment: tenant-self-service-data-sources-20260909-2 — dev
- .test_structured_tool_declares_no_connection_arguments
...
## Communities (1353 total, 45 thin omitted)

### Community 0 - "FakeSession"
Cohesion: 0.03
Nodes (84): A statement that outruns the 10s bound is cancelled, the transaction is rolled…, verification.md rows 6, 7, 13 — the execution path either runs a validated…, FakeLLM, FakeSession, _answer_from(), _AnswerLLM, _orchestrator(), Bounded SQL recovery through the retrieval and answer-generation stages —… (+76 more)

### Community 1 - "session_factory"
Cohesion: 0.04
Nodes (112): build_live_provider(), Build a real SDK-backed provider from a connection's own config and resolved…, The declared set of adapter selections, and which of them are executable. A…, Names of the slots whose recorded selection is not executable in this change., unsupported_selections(), declared_secret_fields(), InvalidSecretReference, ProfileValidationError (+104 more)

### Community 2 - "authFetch"
Cohesion: 0.03
Nodes (108): @tanstack/react-query, JobsPage(), TrainingJob, NewTenantPage(), Tenant, TenantsPage(), TenantsResponse, AuditEventRow() (+100 more)

### Community 3 - "AnnotationPage.tsx"
Cohesion: 0.04
Nodes (70): AnnotationActionBar(), AnnotationActionBarProps, SAVE_LABELS, SaveState, task, AnnotationPage(), mockAuthFetch, MY_TASK (+62 more)

### Community 4 - "extraction.ts"
Cohesion: 0.03
Nodes (60): BaseModelConfirmDialog(), BaseModelConfirmDialogProps, BatchDocumentSelectModal(), EXTRACTED_DOC, FRESH_DOC, MIXED_DOCS, mockUseEligibleDocuments, BatchRunCard() (+52 more)

### Community 5 - "entity_eval/runner.py"
Cohesion: 0.04
Nodes (54): fold_text(), Removes Unicode format characters (general category `Cf`) and folds typographic…, ExpectedEntity, FixtureCase, FixtureError, load_fixture(), _parse_case(), Exception (+46 more)
...
Cohesion: 0.05
Nodes (60): needs_tesseract, classify_processing_error(), ContentUnresolvable, _embed_chunks(), extract_text_doc(), extract_text_image(), extract_text_pdf(), extract_text_pdf_as_image() (+52 more)

### Community 8 - "DocumentIngestionService"
Cohesion: 0.07
Nodes (84): AST, requires_real_stores, Where this document came from, in the source's own terms. Timestamps are never…, SourceReference, Records dispatches without executing them. For tests and for verification row…, RecordingDispatcher, DocumentIngestionService, process_document() (+76 more)

### Community 9 - "test_retrieval_tools.py"
Cohesion: 0.04
Nodes (47): ArgValidationError, assert_no_tenancy_params(), Any, Exception, Protocol, Validates `args` against a minimal JSON-Schema-shaped `args_schema` (type,…, Shared execution wrapper: validates args, times the call, and converts any…, Renders this result into a plain-text observation for an LLM conversation.… (+39 more)

### Community 10 - "DefineEntityTypeSlideOver.tsx"
Cohesion: 0.06
Nodes (33): hankenGrotesk, inter, jetbrainsMono, BASE_LABELS, CARDINALITY_OPTIONS, mockFetch, cardinalityChangeMessage(), DefineEntityTypeSlideOver() (+25 more)

### Community 11 - "_spec"
Cohesion: 0.17
Nodes (11): _child_rows(), _entity(), verification.md rows 14, 15, 24, 33, 34, verification.md rows 4, 22, 32, verification.md rows 35, 36, 37, 38, _spec(), _statements(), _subject() (+3 more)

### Community 12 - "relational_projection.py"
Cohesion: 0.17
Nodes (17): build_projection_statements(), _checked_table(), _child_insert(), _child_params(), project_document_entities(), Projects a document's final entity list into the tenant's generated relational…, `confidence` and `page_number` are projected; provenance is not.…, Every statement that writes this document's relational rows. Executes nothing.… (+9 more)

### Community 13 - "RetrievalResult"
Cohesion: 0.04
Nodes (64): AdmittedEvidence, build_system_prompt(), collapse_duplicate_rows(), _count_tokens(), _dedupe_chunks(), _label_for(), Returns rendered chunk text (label + body), overlap-trimmed. Never mutates…, Exactly what prompt assembly put in front of the model. Citations are derived… (+56 more)

### Community 14 - "FakeSession"
Cohesion: 0.20
Nodes (12): FakeSession, Answers the profile queries from canned tables and every data query with one…, _generations(), _generator(), The repair loop, measured. Verification rows 2 and 3. The Phase 1 claim about…, Row 3 — attempt exhaustion and deadline exhaustion are both `abandoned`, under…, Row 2 — first invalid, second valid., _repair_observations() (+4 more)

### Community 15 - "Source"
Cohesion: 0.03
Nodes (101): field_validator, Queue, chat(), chat_stream(), _check_tenant_and_rate_limit(), create_conversation(), delete_conversation(), get_conversation() (+93 more)
...
Cohesion: 0.05
Nodes (74): JSONResponse, add_bearer_security(), app_error_handler(), health(), lifespan(), exception_handler, FastAPI, get (+66 more)

### Community 18 - "data-sources.ts"
Cohesion: 0.04
Nodes (90): DetailContent(), UPDATABLE, ContractsContent(), handlePublish(), handleUpload(), DataSourcesContent(), isOrder(), isProvider() (+82 more)

### Community 19 - "domain_metrics.py"
Cohesion: 0.04
Nodes (87): main(), Regenerate `docs/observability/metric-contract.md` from the live declarations.…, render_family(), _defect_class(), The defect's category, without its payload. `SQLAttempt.defect` carries the…, _record_metric(), set_trace_id(), allowlist_violations() (+79 more)
...
### Community 22 - "vitest"
Cohesion: 0.03
Nodes (72): vitest, DocumentRow(), DocumentRowProps, formatDate(), purposeLabel(), statusToVariant, baseDoc, BASE_MODEL_ID (+64 more)

### Community 23 - "resolve_query_surface"
Cohesion: 0.04
Nodes (58): _async_dsn(), main(), Provision the least-privilege role that generated chat SQL executes under, then…, build_role_statements(), _checked_identifier(), InvalidIdentifierError, list_tenant_schemas(), provision_role() (+50 more)

### Community 24 - "DenseRetriever"
Cohesion: 0.05
Nodes (67): _fake_vector(), FakeEmbeddingService, main(), Manual playground for HybridRetriever/SparseRetriever/DenseRetriever — no…, Returns a fixed query vector — swap for the real EmbeddingService if you have…, run_query(), setup(), DenseRetriever (+59 more)

### Community 25 - "AuditService"
Cohesion: 0.04
Nodes (68): create_tenant(), create_tenant_user(), CreateTenantRequest, deactivate_tenant(), get_tenant(), list_audit_log(), list_tenant_users(), list_tenants() (+60 more)

### Community 26 - "@testing-library/react"
Cohesion: 0.03
Nodes (36): @testing-library/react, @testing-library/user-event, DataSourceDetailPage(), mockAuthFetch, SchemaContractsPage(), HISTORY, mockAuthFetch, DataSourcesPage() (+28 more)

### Community 27 - "ToolContext"
Cohesion: 0.05
Nodes (76): ContextFactory, KeyError, _create_schema(), main(), CLI entry point for the retrieval eval harness. Seeds the committed synthetic…, Per-instance/per-call override for retrieval behaviour settings. Any field left…, RetrievalConfig, EmbeddingModelMismatchError (+68 more)
...
Cohesion: 0.05
Nodes (43): requires_minio, retry, ContentStore, Protocol, StorageReference, The application-owned boundary for a document's bytes. Three operations and…, Store bytes and return the reference by which they can be reopened. `filename`…, Return the bytes at a previously returned reference, or None if they are gone. (+35 more)

### Community 31 - "sql_generator.py"
Cohesion: 0.04
Nodes (68): accepted_columns(), _error_class(), _filename_filter_literals(), _fix_document_name_reference(), _force_nulls_last_on_desc(), _is_identifier_token(), iter_table_references(), _langsmith_extra() (+60 more)

### Community 32 - "EntityService"
Cohesion: 0.17
Nodes (10): validate_base_label_mapping(), EntityService, AsyncSession, Rejected here, before the write. Migration `037`'s CHECK constraint is the…, The tenant's already-assigned `sql_identifier` values. Per-tenant, not global:…, Bring the tenant's generated tables in line with the catalog it just changed.…, _validate_cardinality(), _validate_value_kind() (+2 more)

### Community 33 - "SQLGenerator"
Cohesion: 0.05
Nodes (44): Raised when every attempt failed. Deliberately an exception rather than a…, The tenant's relations and columns with their semantics and value samples.…, Closed set of per-attempt outcomes. `EMPTY_WITH_DEFECT` is the *only* way a…, Renders prior attempts into the corrective block appended to a retry prompt. At…, One pass of generate -> validate -> execute -> classify., Renders the tenant's relations and columns, each with what it means and a…, The relations a statement may name, as a bare list, for the hard-constraints…, _render_attempt_feedback() (+36 more)

### Community 34 - "test_retrieval_foundation.py"
Cohesion: 0.07
Nodes (25): skip, EmbeddingService, _FakeResult, _FakeSession, Covers verification.md row 38: retrieval-time NER is removed, so…, TestEmbeddingService, TestNERClient, TestSourceAssemblyHasNoNerSources (+17 more)

### Community 35 - "entity_views.py"
Cohesion: 0.03
Nodes (88): _active(), _as_list(), _as_mapping(), build_child_table_statements(), build_entity_table_statements(), build_subject_column_type_statements(), build_subject_table_statements(), catalogued_table_names() (+80 more)

### Community 36 - "logging_config.py"
Cohesion: 0.02
Nodes (106): Formatter, Handler, LogRecord, current_context(), get_tenant_id(), get_trace_id(), get_user_hash(), Ambient request context for telemetry. Threading… (+98 more)

### Community 37 - "eval/metrics.py"
Cohesion: 0.19
Nodes (22): Judgment, compute_query_metrics(), _grade_map(), Judgment, mrr_at_k(), ndcg_at_k(), precision_at_k(), RankedItem (+14 more)
...
### Community 40 - "document_service/main.py"
Cohesion: 0.08
Nodes (47): AsyncEngine, add_bearer_security(), app_error_handler(), health(), health_live(), lifespan(), exception_handler, FastAPI (+39 more)
...
### Community 44 - "extraction_service/worker.py"
Cohesion: 0.09
Nodes (39): create_extraction_run(), find_existing_run(), get_already_extracted(), get_extraction_run(), _get_sync_engine(), insert_entity(), list_extraction_runs(), list_processed_document_ids() (+31 more)

### Community 45 - "test_retrieval_orchestrator.py"
Cohesion: 0.05
Nodes (40): Covers verification.md row 6., Covers verification.md row 7., Covers verification.md row 8., Covers verification.md row 9., Covers verification.md row 10., Covers verification.md row 11 (orchestrator-level slice; HTTP-level in…, Covers verification.md row 12., Covers verification.md row 13. (+32 more)

### Community 46 - "sync.py"
Cohesion: 0.04
Nodes (69): delete_document(), get_document(), get_document_text(), get_session(), get_tenant_id(), list_documents(), AsyncSession, delete (+61 more)

### Community 47 - "test_document_ingestion.py"
Cohesion: 0.09
Nodes (46): extract_text_docx(), is_allowed_file(), Extract paragraph text from a DOCX document., auth_header(), cleanup_public(), client(), _create_tables_sql(), _ensure_profile_table() (+38 more)
...
Cohesion: 0.05
Nodes (35): GuardrailService, _metrics(), One classifier call. Returns True (in-domain) on any error, so a provider…, Returns True if the query is in-domain. Fails open (treats the query as in-…, The domain-metric recorders, resolved on first use. `domain_metrics` imports…, Deterministic short-circuits that decline without an LLM call: a reference to…, Single definition of how much prior conversation each LLM call sees, and how it…, The trailing window of history, oldest first. Empty list when there is none. (+27 more)
...
Cohesion: 0.21
Nodes (17): orchestrate_retrieval(), Top-level entry point: plans, executes, and degrades to a fallback plan (both…, build_default_registry(), _budget(), _context_factory(), _make_chunk(), Uses plan_retrieval + execute_plan directly (bypassing orchestrate_retrieval's…, Covers verification.md row 17. (+9 more)

### Community 56 - "rag_orchestrator.py"
Cohesion: 0.06
Nodes (31): _DummyOrchestrator, main(), Generates a Mermaid diagram for the chat graph's single, fixed topology using…, build_nodes() only closes over this; node bodies never run here., build_chat_graph(), Compiles the chat graph topology. With `entity_resolution_enabled` off (the…, _route_after_entity_resolution(), _route_after_guardrail() (+23 more)

### Community 57 - "DocumentUpload.test.tsx"
Cohesion: 0.10
Nodes (12): ACCEPTED_TYPES, BatchItem, DocumentUpload(), DocumentUploadProps, FileStatus, Deferred, deferreds, uploadCalls (+4 more)
...
### Community 60 - "react"
Cohesion: 0.03
Nodes (64): lucide-react, react, react-markdown, remark-gfm, ChatPage(), Conversation, Message, Source (+56 more)

### Community 61 - "app"
Cohesion: 0.07
Nodes (22): app(), fixture, auth_header(), TestAnalyticsExportEndpoint, auth_header(), TestAnalyticsQueryEndpoint, auth_header(), asyncio (+14 more)
...
### Community 63 - "NormalizedEntity"
Cohesion: 0.09
Nodes (24): filter_valid_entities(), _is_adjacent(), is_valid_entity(), NormalizedEntity, Whether `current` continues the entity `prev` belongs to. Model serving filters…, The entity's surface text. When the caller supplies the full ordered token…, Whether an entity is a fact worth storing. `NOT NULL` does not catch an empty…, Partitions entities into those worth persisting and a count of those dropped.… (+16 more)
...
Cohesion: 0.07
Nodes (50): evaluate_connection(), datetime, Sync scheduling evaluation (CAP-3, ADR-012). The beat scheduler evaluates every…, Decide whether a connection is due for a scheduled run or a catch-up., ScheduleDecision, test_scheduler_cadence_and_catchup_decisions(), active_connection(), enqueued() (+42 more)

### Community 68 - "entity_postprocessor.py"
Cohesion: 0.09
Nodes (41): apply_decisions(), build_candidates(), _build_client(), build_window(), call_postprocessor(), Candidate, _comparable(), _degrade() (+33 more)

### Community 69 - "canonicalize"
Cohesion: 0.09
Nodes (13): canonicalize(), Deterministic fallback (format-character removal, typographic folding, NFKC,…, verification.md rows 10-13, TestCanonicalNormalization, asyncio, Covers verification.md rows 8-11. The defect: `canonicalize()` applied NFKC,…, Row 8's second clause: the point of folding is that the persisted row is…, The development tenant stored a JOB_TITLE whose only content was an em dash;… (+5 more)
...
Cohesion: 0.05
Nodes (41): Favicon — dark theme SVG, Logo — dark theme SVG, Hardcoded-color-to-CSS-variable mapping (text-gray-900 -> var(--ink), bg-white -> var(--surface-2), etc.), Design: Fix Dark Theme Issues Across Portal Pages, Proposal: Fix Dark Theme Issues Across Portal Pages, Fix Dark Theme Issues - Tasks, In-app Logo SVG, Logo (Dark Theme) SVG (+33 more)

### Community 72 - "shared/config.py"
Cohesion: 0.06
Nodes (24): Sync tenant_{id} schemas with tenant_template. Clones missing tables and adds…, _proxy(), proxy_analytics_dashboard(), proxy_analytics_export(), proxy_analytics_query(), proxy_analytics_refresh(), get, post (+16 more)
...
Cohesion: 0.13
Nodes (15): _columns(), fixture, All four entity-definition write paths reconcile the tenant's generated schema,…, verification.md rows 64, 114, verification.md row 115, verification.md rows 65, 67, 68, 116, verification.md row 66, _row_count() (+7 more)

### Community 75 - "test_external_postgresql_chat.py"
Cohesion: 0.06
Nodes (69): clamp_limit(), execute_external_query(), Enforce the server row cap: keep a smaller LIMIT, else append one., Run one drift-gated, validated, parameterized external SELECT. Returns…, accepted_contract(), canonical_fingerprint(), CanonicalContract, ContractValidation (+61 more)
...
Cohesion: 0.08
Nodes (23): eval_gate, BaselineNotFoundError, check_regression(), _comparability_failure(), GateResult, load_baseline(), MetricDelta, Exception (+15 more)
...
Cohesion: 0.07
Nodes (25): langsmith_extra(), One hop between a LangSmith run and the OTel trace it happened inside. They are…, `langsmith_extra=` for one wrapped provider call, or `{}` when unavailable.…, _run_id_setter(), current_trace_id(), Span helpers for the workload instrumentation. Auto-instrumentation gives one…, The ambient trace id as a 32-character hex string, or None outside a trace., A span for one stage, yielding a setter for attributes decided inside the… (+17 more)

### Community 83 - "ContextAssembler"
Cohesion: 0.05
Nodes (38): ContextAssembler, chunk_text(), TestChunkPageMetadata, _make_chunk(), _overlap_marker(), _prose(), Finds a word present in both chunk texts (the shared boundary region)., Covers scenario 6: task 3.4. (+30 more)

### Community 84 - "structured_query_success_rate"
Cohesion: 0.16
Nodes (13): aggregate(), QueryMetrics, Fraction of dispatched structured queries that retrieved their expected rows. A…, Means over every DISPATCHED query. A degraded or failed run contributes its…, A dispatched query that produced nothing usable. Scores zero and counts., structured_query_success_rate(), zero_metrics(), _metrics() (+5 more)
...
### Community 90 - "test_chunk_metadata_ingest.py"
Cohesion: 0.12
Nodes (18): _store_chunks(), Chunk, BaseModel, _fake_vector(), FakeEmbeddingService, asyncio, fixture, integration (+10 more)
...
Cohesion: 0.16
Nodes (15): analytics_export(), analytics_query(), analytics_refresh(), AsyncSession, post, Request, AnalyticsExportRequest, AnalyticsQueryRequest (+7 more)

### Community 96 - "extraction.py"
Cohesion: 0.14
Nodes (35): extract_entities(), get_batch_status(), _get_role(), _get_tenant_id(), list_batch_runs(), list_eligible_documents(), AsyncSession, get (+27 more)
...
Cohesion: 0.04
Nodes (91): setter, build_nodes(), _candidates_to_schema(), _node_outcome(), Candidate, Returns a new RetrievalPlan with every `semantic_retrieval` entry's `scope`…, Returns a dict of node-name -> async callable, each closing over the given…, What this node decided, as a category — never what it decided *about*. Every… (+83 more)
...
Cohesion: 0.07
Nodes (23): _build_windows(), Resolves (window_budget, overlap) in WordPiece units, clamped so that…, Partitions word indices into overlapping `[start, end)` windows, each fitting…, _window_geometry(), _fake_session(), _FakeInput, label_list(), patched_serving() (+15 more)

### Community 105 - "training_service/worker.py"
Cohesion: 0.05
Nodes (36): record_training_completion(), record_training_failure(), _extract_label_set(), fine_tune_model(), _get_sync_engine(), _load_annotated_dataset(), _make_service_token(), MLflowCallback (+28 more)
...
Cohesion: 0.10
Nodes (19): ndarray, Numerically stable softmax over `axis`. Subtracting the per-row maximum before…, softmax(), _fake_session(), _FakeInput, _install_session(), label_list(), patched_serving() (+11 more)
...
Cohesion: 0.34
Nodes (15): create_span(), delete_span(), generate_uuid(), get_session(), get_tenant_id(), list_spans(), prelabel_document(), promote_suggested_span() (+7 more)
...
Cohesion: 0.14
Nodes (24): post, Request, warmup_endpoint(), _get_base_pipeline(), _get_tokenizer(), infer(), _infer_window(), _infer_with_base_model() (+16 more)

### Community 113 - "entity_types.py"
Cohesion: 0.17
Nodes (18): create_entity_type(), delete_entity_type(), EntityTypeCreate, EntityTypeToggle, EntityTypeUpdate, get_entity_type(), list_entity_types(), AsyncSession (+10 more)

### Community 114 - "test_entity_query.py"
Cohesion: 0.19
...
Cohesion: 0.10
Nodes (20): _attributes(), _bodies(), exported(), fixture, Log records leave the process, not just the container's stdout. Verification…, Row 32 — delivery, not emission., The provisioned Loki datasource derives its trace link from `"trace_id": "..."`…, A log store queries on attributes, not on the body text, so the correlation… (+12 more)
...
Cohesion: 0.17
Nodes (8): verification.md row 1 and Risk 7 — the prompt teaches the relational surface,…, Row 1 — no instruction to select from `document_entities`, and no `entity_type`…, Row 5.5 — the graph's scope filter and citation assembly both need it., Task 5.3 — the guidance that was never EAV-specific stays., Task 5.4 — document metadata questions still work; the EAV store is not offered., definition_row(), A `public.entity_definitions` row as the resolver reads it — by column name., TestSQLPrompt
...
### Community 134 - "eligibility_tenant_schema"
Cohesion: 0.16
...
Cohesion: 0.03
Nodes (71): _candidates_from_json(), _candidates_to_json(), clear_binding(), clear_pending(), ConversationState, decode_document_ids(), encode_document_ids(), increment_reask() (+63 more)
...
### Community 144 - "test_relational_projection_generator.py"
Cohesion: 0.14
Nodes (11): build_routing_index(), `uppercased entity_type literal -> the one definition that claims it`. Only…, _executable_string_literals(), Pure-function tests for the relational projection. Database-free, deliberately.…, verification.md rows 10-12, verification.md row 13, verification.md row 4 — the builders touch no database., Every string constant in the module that is not a docstring. Source-text… (+3 more)
...
Cohesion: 0.25
Nodes (24): create_access_token(), client(), fixture, The document service's own app: `/api/v1/documents` is served there, not by…, tenant(), auth_header(), AsyncClient, asyncio (+16 more)

### Community 148 - "test_training_metrics.py"
Cohesion: 0.08
Nodes (17): BaseException, Map a raised exception onto the enumerated failure causes. Deliberately coarse.…, _training_failure_cause(), _duration_count(), _failures(), parametrize, Training reports its lifecycle. Model quality stays in MLflow. Verification…, Row 23 — the registry walk. (+9 more)
...
Cohesion: 0.07
Nodes (35): BaseSettings, model_validator, Inject database_ssl_mode into the default connection URLs when the URLs…, Settings, clean_ner_environment(), parametrize, Run with no `NER_` variables set, restoring them afterwards. The suite's own…, Row 30 — no plaintext secret defaults in `src/shared/config.py`. (+27 more)

### Community 151 - "model_serving/api/v1/schemas.py"
Cohesion: 0.18
Nodes (19): get_tenant_id(), inference_endpoint(), post, Request, get_tenant_id(), post, Request, rerank_endpoint() (+11 more)
...
Cohesion: 0.05
Nodes (48): react-dom, mockAuthFetch, mockUseAnnotationImport, mockUseAuth, mockUseEntityTypes, buildEntityColors(), ENTITY_COLORS, ImportedDocumentReview() (+40 more)
...
Cohesion: 0.11
Nodes (15): download_model_artifacts(), _get_s3_client(), auth_header(), asyncio, Tests for model-serving warmup endpoint., ADR-006: Model artifacts path must follow tenants/{tid}/models/v{version}/., Task 3.6: Model loads on-demand when cache is empty., Task 3.5: Warmup → cache populated, verified via subsequent lookup. (+7 more)
...
### Community 169 - "StructuredRetrievalTool"
Cohesion: 0.23
Nodes (11): Answers a natural-language question against extracted structured entity data.…, StructuredRetrievalTool, _orchestrator_with(), Row 31 at the tool boundary: an error ToolResult, not an empty success., A failure must not arrive downstream as a successful empty., The deliberate asymmetry with the test above., A recovered query is diagnosable from the ToolResult alone., A failure with no trace would not be diagnosable. (+3 more)
...
Cohesion: 0.25
Nodes (15): contract_history(), _error(), _owned_pg_connection(), publish_contract(), AsyncSession, get, post, Request (+7 more)
...
Cohesion: 0.16
Nodes (15): get_db(), AsyncSession, Request, handle_extraction_completed(), task, refresh_analytics_materialized_views(), assert_tenant_schema(), Check a schema name against the tenant-schema pattern before it is… (+7 more)
...
Cohesion: 0.08
Nodes (58): _require_keys(), Tenant-scoped Azure connection control plane (CAP-2, ADR-011)., LifecycleRejected, Exception, A lifecycle action the connection's state, evidence, or limits forbid. Carries…, ConnectionValidationError, Exception, The finite approved provider catalog for the tenant control plane (CAP-2). Only… (+50 more)
...
### Community 186 - "test_no_pii_in_chat_telemetry.py"
Cohesion: 0.17
Nodes (10): FakeLLM, _all_metric_label_values(), _generator(), fixture, Everything one chat request emits, checked against the content it was built…, The corollary. A telemetry surface that carries nothing useful also passes…, Drive one question end to end through the instrumented generation path., _rendered_records() (+2 more)
...
### Community 190 - "_compute_bio_tags"
Cohesion: 0.20
Nodes (13): _compute_bio_tags(), Return BIO tag sequence for tokens in [char_start, char_end) using whitespace…, Unit tests for _compute_bio_tags in spans.py., Two-token span produces B- then I-., Span not starting at position 0 computes correct absolute offsets., Span covering three tokens produces B + I + I., Span in the middle of a sentence only tags relevant tokens., Single-token span produces only a B- tag. (+5 more)

### Community 191 - "TestValueKindChangeConvergesTheColumn"
Cohesion: 0.20
Nodes (9): _column_type(), _persisted_value_kind(), verification.md rows 1, 2, 13. The catalog and the column have to move together…, Row 1, through the write path an admin actually uses., Row 2 — the correction the observed `PHONE_NUMBER` misconfiguration needed., The invariant itself, stated over the pair rather than over either half., Row 13 — the catalog must not commit over a schema that did not converge. Runs…, Editing a description must not disturb the column — the reconcile runs on every… (+1 more)
...
### Community 198 - "TestExecutionUnderRestrictedRole"
Cohesion: 0.27
...
### Community 220 - "init_observability"
Cohesion: 0.07
Nodes (29): _init_worker_observability(), connect, Wire this worker's telemetry when it starts as a worker. Bound to the signal…, add_bearer_security(), app_error_handler(), health(), lifespan(), exception_handler (+21 more)
...
### Community 232 - "entities.py"
Cohesion: 0.28
Nodes (12): _get_tenant_id(), _get_user_id(), list_entities(), patch_entity(), AsyncSession, get, Request, EntityItem (+4 more)
...
### Community 236 - "FakeUpstreamResponse"
Cohesion: 0.24
Nodes (7): _FakeRequest, FakeUpstreamResponse, _patch_upstream_client(), Covers verification.md rows 21, 22 (tasks 3.3, 3.4). Calls `proxy_chat_stream`…, Stands in for the `httpx.Response` returned by `client.send(req, stream=True)`…, Duck-typed stand-in for `starlette.Request` carrying only what…, TestChatStreamGatewayProxy
...
Cohesion: 0.12
Nodes (24): Identifier, ExternalExecutionFailed, Exception, Drift-gated read-only external query execution (CAP-4, ADR-013). Order per…, The external database failed; carries the error class only., _record(), _check_columns(), _first_keyword() (+16 more)
...
Cohesion: 0.14
Nodes (36): enqueue_sync(), activate_data_source(), _body_digest(), create_data_source(), _created(), _enqueue_blob_sync(), _error(), _idempotency_key() (+28 more)
...
Cohesion: 0.07
Nodes (16): _count_rejection(), Count one rejection, splitting the bucket key into its scope and tenant. Keys…, SlidingWindowRateLimiter, The four counters Exit Gate 3 names: mismatch, auth failure, rate-limit…, Row 32's second clause. The reason is drawn from the exception type, so there…, The tenant label here is deliberate: a rejected request produces the least…, The current value of one series, or 0 when it has never been recorded., Row 27. The counter lives in the constructor, so *raising* is not required —… (+8 more)
...
Cohesion: 0.29
Nodes (4): _patch(), TestChatGatewayProxy, auth_header(), TestExtractionGatewayProxy

### Community 527 - "lifecycle.py"
Cohesion: 0.10
Nodes (23): external_chat_answer(), ExternalNotExecutable, Exception, External PostgreSQL chat capability (CAP-4, ADR-013). A separate selection from…, Answer one external chat turn: resolve, then drift-gated execution. Returns…, No executable external capability for this tenant; finite reason only., Finite lifecycle, test, and activation evidence classes (CAP-2). Every value…, active_connection() (+15 more)
...
### Community 543 - "value_for_column"
Cohesion: 0.29
Nodes (5): The value a `subject` column receives, decided by the definition's…, value_for_column(), parametrize, verification.md rows 19-21, TestValueKindMapping
...
### Community 799 - "testing.py"
Cohesion: 0.24
Nodes (8): _endpoint_for(), The secure connection-test seam (CAP-2). A test resolves the connection's…, The finite result of one secure connection test., Register (or replace) the tester for one provider. Fakes use this too., The shipped tester: TCP connect plus TLS handshake, credentials never sent. A…, register_tester(), SecureTestResult, TlsHandshakeTester

### Community 800 - "AssignTaskForm.test.tsx"
Cohesion: 0.22
Nodes (9): adminUser, annotatorUser, failedDoc, makeQC(), mockAuthFetch, mockToast, pendingDoc, processedDoc (+1 more)
...
### Community 858 - "TestTheDefectPayloadNeverBecomesALabel"
Cohesion: 0.22
Nodes (5): _attempts(), parametrize, Design Decision 2 and risk 1 — the highest-risk aspect of this change, and not…, A fourth defect kind added upstream without widening `DEFECT_CLASSES` lands on…, TestTheDefectPayloadNeverBecomesALabel
...
### Community 956 - "route_entities"
Cohesion: 0.31
Nodes (4): `sql_identifier -> entities routed to it`, skipping every unroutable entity. An…, route_entities(), verification.md rows 6-9, TestRouting
...
### Community 1109 - "build_relational_delete_statements"
Cohesion: 0.36
...
Cohesion: 0.29
Nodes (7): Bugs: Tenant Self-Service Data Sources, DS-001: Last-run status never updates, DS-002: Portal shows `INTERNAL_ERROR` for every data-source error, DS-003: Blob sync scheduler appears stuck, DS-004: Gateway blocks its event loop while enqueuing a manual sync, DS-005: Gateway had no Celery broker configured, DS-006: Blob sync containers download the tokenizer at startup and die if it fails
...
### Community 1256 - "select_single_value"
Cohesion: 0.36
...
### Community 1308 - "TestOneChatRequestLeaksNothing"
Cohesion: 0.32
Nodes (4): parametrize, The assertion that makes the three above mean anything. A scan that inspects…, Row 6 — spans, labels and log records from the same request, checked together., TestOneChatRequestLeaksNothing
...
### Community 1311 - "TestStructuredValueSQLExecution"
Cohesion: 0.39
...
### Community 1315 - "_scope_to_document_ids"
Cohesion: 0.43
Nodes (3): Translates the capability's `scope` argument into the document identifiers the…, _scope_to_document_ids(), TestScopeArgumentPlumbing
...
### Community 1330 - "TestExecutionIsMeasured"
Cohesion: 0.40
Nodes (3): Task 4.4 — duration, rows and truncation., An answer built from a capped row set is a different claim about the tenant's…, TestExecutionIsMeasured
...
### Community 1344 - "run_query_orchestrated"
Cohesion: 0.67
Nodes (3): QueryRunResult, Runs a golden-set query through the Intent Orchestrator's plan-and-execute path…, run_query_orchestrated()
...
## Knowledge Gaps
- **9081 isolated node(s):** `$schema`, `plugin`, `vendorRoot`, `SessionMessage`, `SessionMessageInfo` (+9076 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 12124 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
